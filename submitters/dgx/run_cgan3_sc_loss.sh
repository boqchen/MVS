#!/bin/bash
experiment_name="split3_otsu3_seed3_selected_snr-weight_SC-Boqi"
...
python -m codebase.experiments.cgan3.main --cv_split="split3" --protein_set="selected_snr" --submission_id="${submission_id}" --no_zip --model_depth=6 --imc_prep_seq="raw_clip99_arc_otsu3" --standardize_imc=True --scale01_imc=True --seed=3 --which_cluster="dgx:6" --which_HE='new' --trans_weights_init='no_init' --dis_weights_init='no_init' --p_flip_jitter_hed_affine='0.5,0,0,0' --which_translator='no_checkerboard' --trans_lr_scheduler='fixedqeual' --dis_lr_scheduler='fixedqeual' --batch_size=8 --n_step=500000 --vis_interval=5000 --weight_SC=10
