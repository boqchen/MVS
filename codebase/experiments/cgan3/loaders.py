...
## -----------------------------------
# Updated version of dataloader 
## -----------------------------------
# modifying the current setup with transform functions and probability 
# flow: data loader with transforms --> batch to device in main.py
...
# loadrs at inference time 
class Eval_dataset(Dataset):
    def __init__(self, imc_pred_paths, imc_roi_storage, channel_list, data_range=(0, 1), convert_to_rgb=False):
    ...
    def __getitem__(self, idx):  
        ...
        # channel last 
        # imc_pred = imc_pred.permute(1, 2, 0)
        # imc_gt = imc_gt.permute(1, 2, 0)
