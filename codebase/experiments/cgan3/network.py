...
from torch.nn import ModuleList, Conv2d, ConvTranspose2d, Linear
...
class EQLinear(Linear):
    def __init__(self, in_features, out_features, bias=True, bias_init=0., lr_mul=1.) -> None:
        super().__init__(in_features, out_features, bias)

        # init weights from Normal
        torch.nn.init.normal_(self.weight, mean=0., std=1./lr_mul)
